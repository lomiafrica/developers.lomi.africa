...
| `product_id`        | string (UUID)  | Yes, if `link_type` is `product`       | ID of the Lomi [Product](./products) to link.                                                          |
| `plan_id`           | string (UUID)  | Yes, if `link_type` is `plan`          | ID of the Lomi [Subscription Plan](./subscriptions) to link.                                             |

...
Lomi authenticates your API requests using API keys. Any request that doesn't include a valid API key will return an authentication error.
...
1.  Log in to your [Lomi Dashboard](https://dashboard.lomi.africa/).
2.  Navigate to the **Developers** or **API Settings** section.
3.  Generate separate API keys for the **Test** and **Live** environments.

## Key management and security

Treat your API keys as sensitive credentials. You can manage them (generate, revoke, view usage) in the Lomi Dashboard.

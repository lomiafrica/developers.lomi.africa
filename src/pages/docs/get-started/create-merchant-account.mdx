...
- Business registration in any country of the world.
...
### 1. Create your account and get your API keys
...
### 3. Install lomi. with your CLI

The lomi. CLI tool provides convenient commands for interacting with the API, managing resources, and testing webhooks. More information on how to use the CLI is available on its dedicated page: [lomi. CLI Documentation](/docs/cli) *(xxxxxx)*

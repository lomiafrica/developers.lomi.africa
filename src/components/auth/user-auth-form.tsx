    ...
    <div className={cn("grid gap-6 w-[300px] sm:w-full", className)} {...props}>
      ...
      <div className="flex flex-col gap-4">
        <Button
          ...
          className="w-full h-12 px-3 rounded-none bg-white hover:bg-gray-50 dark:bg-[#202020] dark:hover:bg-[#2a2a2a] text-gray-600 dark:text-white border border-gray-300 dark:border-0 text-sm font-medium transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <Button
          ...
          className="w-full h-12 px-3 rounded-none bg-[#333] hover:bg-[#444] dark:bg-[#171515] dark:hover:bg-[#2b2a2a] text-white text-sm font-medium transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <div className="flex items-center justify-center">
            {isGithubLoading ? (
              <Spinner className="w-4 h-4" />
